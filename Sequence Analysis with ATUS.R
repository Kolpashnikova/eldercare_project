...
df <- zip_to_df("https://www.bls.gov/tus/special.requests/atusact-0320.zip", "data")
head(df)


df_ec <- zip_to_df("https://www.bls.gov/tus/special.requests/atusrostec-1120.zip", "data")
head(df_ec)
...
#as.numeric(difftime(strptime(diary$stop[1], "%H:%M:%S"), strptime(diary$start[1], "%H:%M:%S")))
...
## create sequences of activities per activity
